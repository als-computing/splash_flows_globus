...
from globus_sdk import (
    ConfidentialAppAuthClient, ClientCredentialsAuthorizer, SpecificFlowClient,
    TransferClient
)
from globus_sdk.scopes import TransferScopes, MutableScope, GCSCollectionScopeBuilder
...
def get_specific_flow_client(flow_id, collection_ids=None):
    ...
    # transfer_authorizer = ClientCredentialsAuthorizer(confidential_client, transfer_scopes)
    # transfer_client = TransferClient(authorizer=transfer_authorizer)

    return flow_client #, transfer_client