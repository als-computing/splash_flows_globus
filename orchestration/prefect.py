...
async def schedule(deploymnent_name, flow_run_name, parameters, duration_from_now: datetime.timedelta, logger=logger):
...
def schedule_prefect_flow(deploymnent_name, flow_run_name, parameters, duration_from_now: datetime.timedelta):
    logger = get_run_logger()
    asyncio.run(schedule(deploymnent_name, flow_run_name, parameters, duration_from_now, logger))
    return
