...
class NerscClient:
    def __init__(self, path_client_id=None, private_key=None, logger=None):
        self.path_client_id = (
            default_path_client_id if path_client_id is None else path_client_id
        )
        self.path_private_key = (
            default_path_private_key if private_key is None else private_key
        )
        self.logger = (
    ...
    def cdtools(self, cxiname, n_gpu, **kwargs):
        args_string = cdtool_args_string(
            cxiname, default_path_cdtools_nersc, cdtools_parms, **kwargs
        )
